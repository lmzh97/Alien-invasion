...
def record_high_score_and_qiut(stats):
    filename = 'High_score_recorder.json'
    with open(filename, 'w') as high_score_recorder:
        json.dump(stats.high_score, high_score_recorder) 
    sys.exit()
    
    

def check_keydown_events(event, ship, ai_settings, stats, screen,
        bullets):
    if event.key == pygame.K_RIGHT:
        ...
        record_high_score_and_qiut(stats)
...
def check_events(ai_settings, screen, stats, sb, play_button, ship,
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_keydown_events(event, ship, ai_settings, stats,
                screen, bullets)
